...
function DepartmentMasterDashboard() {
  ...
  const getDepartmentMaster = async () => {
    ...
    const { data } = await axios.get(hostURL + "Master/GetDepartmentMaster"); //Api call to fetch the data that is being displayed in table
    ...
    try {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          const res = axios.get(hostURL + `Master/DeleteDepartmentMaster?ID=${id}`); //api call to delete the data from the table
