...
function DepartmentMasterForm() {
    ...
    async function onSubmit(data) {
        ...
        if (actionType == "insert") {
            ...
            await axios.post(hostURL + 'Master/InsertDepartmentMaster', data); //api call for insert of data
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post(hostURL + 'Master/UpdateDepartmentMaster', data); //api call for updating the data
                    Swal.fire(
                        'Updated!',
    ...
    useEffect(() => {
        async function getDepartmentMasterByID() {
            ...
            if (id) {
                ...
                const response = await axios.get(hostURL + 'Master/GetDepartmentMasterByID?id=' + id); //getByID api call
